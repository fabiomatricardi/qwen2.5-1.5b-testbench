...
prmpt_coll = [
"""Hhi there my name is Fabio. who are you?""",
...
""",
"""write the content of the following text in the form of "Table of Contents". A table of content is an ordered list ot the topic contained in the text.
...
""",
"""extract the five most important topics from the following text:
...
for items in prmpt_coll:
    test = []
    print(items)
    print("\033[91;1m")  #red
    print(items)
    test.append({"role": "user", "content": items})
    print("\033[92;1m")
    ...
    prompttokens = countTokens(items)
...
'''
    print(stats)
    writehistory(logfilename,f'''👨‍💻: {items}
💻 > {full_response}
{stats}
📝Logfile: {logfilename}''')
